...
public class LogRecepciones {
    ...
    public String getSy_origen() { return sy_origen; }
    public void setSy_origen(String sy_origen) { this.sy_origen = sy_origen; }
    ...
    public void setModel_device(String model_device) { this.model_device = model_device; }
}
