 ...
 */
@WebServlet("/token_qas")
public class S4GCP_QAS_Mobile extends S4CommMain {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(S4GCP_QAS_Mobile.class);

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public S4GCP_QAS_Mobile() {
		super();
	}
...
//			}
	...
	private String login3(HttpServletRequest request, HttpServletResponse response, String body, S4GCP_QAS_Mobile s4,
	...
	private String logout(HttpServletRequest request, HttpServletResponse response, String body, S4GCP_QAS_Mobile s4,
			String versionName) throws IOException, SQLException, NoSuchAlgorithmException {
		OdataStructure osIncoming = new OdataStructure();
	...
	private String recoverUser(HttpServletRequest request, HttpServletResponse response, String body,
			S4GCP_QAS_Mobile s4, String versionName) throws IOException, SQLException, NoSuchAlgorithmException {
		OdataStructure osIncoming = new OdataStructure();
