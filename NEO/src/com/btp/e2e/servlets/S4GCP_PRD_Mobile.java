 ...
 */
@WebServlet("/token_prd")
public class S4GCP_PRD_Mobile extends S4CommMain {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(S4GCP_PRD_Mobile.class);

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public S4GCP_PRD_Mobile() {
		super();
	}
	...
	protected void handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			File root = new File("./");
			this.findFile(root, "kprd.json");

//			if (!request.getRequestURL().toString().contains("hd428f378") && this.fileLock != null) {
//
//				StringWriter writer = new StringWriter();
//				IOUtils.copy(this.fileLock, writer, "UTF-8");
//				System.err.println(writer.toString());
//
//				// InputStream openStream =
//				// this.getClass().getResourceAsStream("/key-prd.json");
//				System.out.print(this.fileLock);
//				System.err.print(this.fileLock);
//				GoogleCredentials credentials = GoogleCredentials.fromStream(this.fileLock);
//
//				credentials.refreshIfExpired();
//				AccessToken token = credentials.getAccessToken();
//				objectToReturn = "{ \"res\": \"Bearer " + token.getTokenValue() + "\" }";
//			}
	...
	private String login3(HttpServletRequest request, HttpServletResponse response, String body, S4GCP_PRD_Mobile s4,
		...
		long TIME_TO_EXPIRE = 1000 * 60 * 60;
	...
	private String logout(HttpServletRequest request, HttpServletResponse response, String body, S4GCP_PRD_Mobile s4,
			String versionName) throws IOException, SQLException, NoSuchAlgorithmException {
		OdataStructure osIncoming = new OdataStructure();
	...
	private String recoverUser(HttpServletRequest request, HttpServletResponse response, String body,
			S4GCP_PRD_Mobile s4, String versionName) throws IOException, SQLException, NoSuchAlgorithmException {
		OdataStructure osIncoming = new OdataStructure();
