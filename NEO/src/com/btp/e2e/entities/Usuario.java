...
public class Usuario extends PojoPrimary {
	...
	public Usuario(String id, String rut, String clave, String nombre, String telefono, String email, String topeDeuda,
			String token, String imei, String tipo, String rol, String numero_camion, String terminal, String idPush,
			String lista_pedido, String bloqueado, String usadescuentos, String centro, String oferta,
			String timestamp) {
		super();
		this.id = id;
		this.rut = rut;
	...
	private boolean stock_consignado;
	...
	public String getTokenAWS() {
		return tokenAWS;
	}

	public void setTokenAWS(String tokenAWS) {
	...
	/**
	 * @return the stock_consignado
	 */
	public boolean getStock_consignado() {
		return stock_consignado;
	}

	/**
	 * @param stock_consignado the stock_consignado to set
	 */
	public void setStock_consignado(boolean stock_consignado) {
